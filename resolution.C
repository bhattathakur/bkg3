{
  ...
  char  dataafile[]="DATA/bkg3finalEnergyerror.dat";//A,mean,sigma,error in A,error in mean, error in sigma,N
  char pdfresoluton[]="PLOTS/bkg3resolutionplot.pdf"; //pdf file to save the plot
  const   char* finalresults="DATA/bkg3results_from_resolution.dat";//stores the results obtained form the resolution plot
  const  char* savingtoroot="ROOTFILES/bkg3resolution.root";// saves the plot in the root file
