{
  ...
  const char * filename="ROOTFILES/bkg3initial.root"; //access the original histogram
  const char * allhistogramsfile="ROOTFILES/bkg3initial_allhistogram.root"; //Dave the histogram
  char  file_estimated_parameters[]="DATA/bkg3initialestimates.dat"; //file storing the estimated parameters for fit
  char  outputfile[] ="DATA/bkg3initialEnergyerror.dat";
  char initialcanvaspdf[]="PLOT/bkg3initialcanvas.pdf";
  const  int peakNo=23;
  const  int column=6;
