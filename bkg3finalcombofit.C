{
  ...
  const char * filname="ROOTFILES/bkg3final.root"; //access the original histogram
  const  char * finalallhistograms="ROOTFILES/bkg3final_allhistogram.root";
  char  estimated_parameter_files[]="DATA/bkg3finalestimates.dat"; //file storing the estimated parameters for fit
  char  finaloutputfile[] ="DATA/bkg3finalEnergyerror.dat"; //Output file to store A,u,6,eA,eu,e6
