...
{
   //Defining the files
  const char * root_file="ROOTFILES/bkg3final.root"; //Stores the root file
  const char * inputdatafile="DATA/bkg_01_000.dat"; //original data files which stores two columns of data
  const char * intercept_slopefile="DATA/bkg3slope_intercept.dat";
